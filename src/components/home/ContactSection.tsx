...
const contactMethods = [
  {
    ...
    contact: "Give us a call anytime",
    action: "/contact",
      ...
      <div className="container mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto">
            Have questions about our fiber internet service? Our team is here to help you find the perfect plan.
          </p>
        </motion.div>
        ...
        >
          <div className="bg-card rounded-xl sm:rounded-2xl p-6 sm:p-8 text-center border border-border">
            ...
            <p className="text-sm sm:text-base text-muted-foreground">Our team is available around the clock to assist you</p>
          </div>
          <div className="bg-card rounded-xl sm:rounded-2xl p-6 sm:p-8 text-center border border-border">
            <div className="w-14 h-14 sm:w-16 sm:h-16 bg-accent/10 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
        ...
        >
          ...
          <h3 className="heading-md text-accent-foreground mb-4">Ready to Get Started?</h3>
          <p className="text-accent-foreground/90 text-lg mb-8 max-w-2xl mx-auto">
            Experience lightning-fast fiber internet today. Our team is ready to help you choose the perfect plan for your needs.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" variant="secondary" className="bg-white text-accent hover:bg-white/90" asChild>
              <a href="tel:+18559450333">Check Availability</a>
            </Button>
